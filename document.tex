...
\begin{figure}[ht]
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \addplot[black, thick, domain=2:10]{20/x};
      \addplot[black, thick]coordinates{(0,10)(2,10)};
      \addplot[black, thick]coordinates{(10,.3)(10,2)};
      \addplot[black, thin, dashed]coordinates{(-3,0)(11,0)};
      \addplot[black, thick]coordinates{(0,.3)(0,10)};
      \addplot[black, name path=cbp, thick]coordinates{(0,.3)(10,.3)};
      \addplot[black, thin]coordinates{(2,0)(2,10)};
      \addplot[black, thin, dashed]coordinates{(5,0)(5,4)};
      \addplot[black, thin, dashed]coordinates{(2.50,0)(2.50,8)};
      \addplot[black, thin]coordinates{(-.1,1)(.2,1)};
      \addplot[black, thin]coordinates{(0,2)(10,2)};
      \addplot[black, thin]coordinates{(-.1,3)(.2,3)};
      \addplot[black, thin]coordinates{(0,4)(5,4)};
      \addplot[black, thin]coordinates{(-.1,5)(.2,5)};
      \addplot[black, thin]coordinates{(-.1,6)(.2,6)};
      \addplot[black, thin]coordinates{(-.1,7)(.2,7)};
      \addplot[black, thin]coordinates{(0,8)(2.50,8)};
      \addplot[black, thin]coordinates{(-.1,9)(.2,9)};
      \addplot[black, thin]coordinates{(0,0)(0,.3)};
      \addplot[black, thin]coordinates{(10,0)(10,.3)};
      \node at (axis cs:2,10.4) {\tiny $A$};
      \node at (axis cs:.4,10.4) {\tiny $P$};
      \node at (axis cs:0,-.5) {\tiny $O$};
      \node at (axis cs:10.4,.4) {\tiny $K$};
      \node at (axis cs:10.4,1.9) {\tiny $D$};
      \node at (axis cs:1.8, -.6) {\tiny $V_1$};
      \node at (axis cs:2.7, -.6) {\tiny $V_2$};
      \node at (axis cs:5, -.6) {\tiny $V_3$};
      \node at (axis cs:10,-.6) {\tiny $V_4$};
      \node at (axis cs:-2,-.4) {\tiny Zero Line};
      \node at (axis cs:.4,1.7) {\tiny $F$};
      \node at (axis cs:.4,3.7) {\tiny $G$};
      \node at (axis cs:.4,7.7) {\tiny $H$};
      \node at (axis cs:2.9,8) {\tiny $B$};
      \node at (axis cs:5.4,4.1) {\tiny $C$};
      \node at (axis cs:-.5,1) {\tiny 25};
      \node at (axis cs:-.5,2) {\tiny 50};
      \node at (axis cs:-.7,4) {\tiny 100};
      \node at (axis cs:-.7,6) {\tiny 150};
      \node at (axis cs:-.7,8) {\tiny 200};
      \node at (axis cs:-.7,10) {\tiny 250};
      \node[rotate=90] at (axis cs:-1.7,5.2) {\tiny Absolute Pressure LBS Per SQ Inch};
    \end{axis}
  \end{tikzpicture} \\
  \tiny{Stroke of Piston or Line of Volume.}
  \caption*{\textsc{Fig.\ 4.}}
\end{figure}
